# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2017-09-20 03:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('datastore', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='installation.Datastore')),
            ],
            options={
                'db_table': 'vm_guest',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ip', models.GenericIPAddressField(blank=True, null=True, unique=True)),
                ('cluster', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='installation.Cluster')),
            ],
            options={
                'db_table': 'vm_host',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('power', models.CharField(blank=True, default='on', max_length=10, null=True)),
                ('create_time', models.DateTimeField(auto_now_add=True)),
                ('update_time', models.DateTimeField(auto_now=True)),
                ('cabinet', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='opsdb.Cabinet')),
                ('contacter', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='opsdb.Contacter')),
            ],
            options={
                'ordering': ['-create_time'],
                'db_table': 'server',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('guest', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='installation.Guest')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='server',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='installation.Server'),
        ),
        migrations.AddField(
            model_name='nic',
            name='server',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='installation.Server'),
        ),
        migrations.AddField(
            model_name='host',
            name='server',
        ...
        migrations.AddField(
            model_name='guest',
            name='host',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='installation.Host'),
        ),
        migrations.AddField(
            model_name='disk',
            name='server',
        ...
        migrations.AddField(
            ...
            name='vcenter',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='installation.Vcenter'),
        ),
        migrations.AddField(
            model_name='cluster',
            name='datacenter',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='installation.Datacenter'),
        ),
    ]
